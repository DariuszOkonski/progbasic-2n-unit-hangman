...
# - zwrócić poziom od 7 do 3 do zmiennej LIVES
# - odczytać plik i zwrócić losowe państwo do zmiennej WORLD

# - ==================  dalej wszystko będzie się działo w funkcji PLAY
# - wyswietlić initial state of game _ _ _ _ _ oraz liczbę żyć
# - pobrać literę od użytkownika z zakresu a-z A-Z
...
#       jeśli użytkownik nie ma już żyć to konieć gry i wyświetlić mu szukane hasło
